...
class Shader {
	...
	void set(const std::string_view& name, const GLfloat val, const GLfloat val2, const GLfloat val3) const;
	...
	void set(const std::string_view& name, const Eigen::Affine3f& mat, const GLboolean transpose = GL_FALSE) const;
